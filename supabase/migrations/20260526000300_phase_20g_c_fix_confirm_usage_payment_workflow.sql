-- Phase 20G-fix: correct private.confirm_usage_payment_workflow_v1
-- Uses private.set_actor_context (correct pattern) and removes redundant actor switch.
-- Wrapper already sets SYSTEM context; workflow runs fully under SYSTEM.
...
begin
  ...
  -- NOTE: wrapper already runs as SYSTEM; no actor switch needed.
